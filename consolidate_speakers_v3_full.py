...
class EnhancedSpeakerConsolidatorV3:
    ...
    def calculate_profile_score(self, profile: Dict[str, Any]) -> int:
        ...
        # Expertise (20 points) - Enhanced scoring with industry normalization
    ...
    def create_indexes(self):
        ...
        # Text search index - enhanced with industry keywords
        ...
        collection.create_index("expertise.normalized_industries.secondary")  # NEW
    ...
    def print_stats(self):
        """Print consolidation statistics with industry breakdown"""
        logger.info("\n" + "="*50)
        logger.info("ENHANCED CONSOLIDATION STATISTICS V3")
        logger.info("="*50)
        ...
        if industry_stats:
            ...
            for industry, count in sorted(industry_stats.items(), key=lambda x: x[1], reverse=True)[:10]:
                ...
                if industry_info:
                    logger.info(f"  {industry_info['display_name']}: {count:,}")
